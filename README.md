...
| Path                     | Contents                                                        |
|--------------------------|-----------------------------------------------------------------|
| `firmware/master/`       | Master CubeIDE project (`Core/`, `STM32_WPAN/`, `FATFS/`)       |
...
| `host/live_tool/`        | Browser live-inference tool (Web Bluetooth + ONNX Runtime Web)  |
| `host/desktop_tool/`     | Browser recording/commissioning page + BIN→CSV converter        |
...
snapshot is ready to be committed.
